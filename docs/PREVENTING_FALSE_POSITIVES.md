...
```
/home/joseph/Downloads + proton:/Downloads 
→ home_joseph_Downloads..proton_Downloads.{path1,path2}.lst*
```
...
**Example:**
```bash
LOCAL_PATH="/home/joseph/Documents/Work"
REMOTE_PATH="proton:/Projects/Work"

# Becomes:
home_joseph_Documents_Work..proton_Projects_Work.*
```
...
2. Verify cache created:
   ...
   # Should show: home_joseph_Downloads..proton_Downloads.*
   ```
...
- `home_joseph_Documents..proton_Documents.*`

Preserves:
- `home_joseph_Documents_Work..proton_Work.*`
