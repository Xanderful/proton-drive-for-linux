#!/bin/bash
# DEPRECATED: WebClients are no longer used in native GTK4 builds
echo "⚠️  WebClients build script is deprecated."
echo "   The native GTK4 application does not require WebClients."
exit 0
set -euo pipefail
