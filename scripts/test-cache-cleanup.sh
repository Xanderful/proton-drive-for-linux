...
touch "$FAKE_CACHE/home_user_Downloads..proton_Downloads.path1.lst-new"
touch "$FAKE_CACHE/home_user_Downloads..proton_Downloads.path2.lst-new"
touch "$FAKE_CACHE/home_user_Downloads..proton_Downloads.path1.lst-old"
touch "$FAKE_CACHE/home_user_Downloads..proton_Downloads.path2.lst-old"

# Also create stale cache from buggy doubled path
touch "$FAKE_CACHE/home_user_Downloads_Downloads..proton_Downloads.path1.lst-new"
touch "$FAKE_CACHE/home_user_Downloads_Downloads..proton_Downloads.path2.lst-new"
...
doubled_pattern="home_user_Downloads_Downloads..proton_Downloads"
...
stale_pattern="home_user_Downloads_Downloads..proton_Downloads"
...
touch "$FAKE_CACHE/home_user_Documents..proton_Documents.path1.lst-new"
touch "$FAKE_CACHE/home_user_Documents..proton_Documents.path2.lst-old"

echo "Created job: test-job-456"
echo "  Local:  /home/user/Documents"
